function LoginView(props){
    ...
    return(
        ...
        <p className="fontSize">Log in</p>    
            ...
            <div>Username</div>
            <input className="input" autocomplete="off" placeholder = "Enter name..." type = "text" id = "loginName" onInput={(e)=> name = e.target.value} />

            <div>Password</div>
            <input className="input" autocomplete="off" placeholder = "Enter password..." type = "password" id = "loginPass" onInput = {(e)=> pass = e.target.value}/>
